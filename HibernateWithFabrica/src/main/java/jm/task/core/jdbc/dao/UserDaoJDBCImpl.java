...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void saveUser(String name, String lastName, byte age) {
        ...
        try (PreparedStatement prSt = util.getConnection().prepareStatement(Sqlinsert)) {
    ...
    public void removeUserById(long id) {
        ...
        try (Statement statement = (Statement) util.getConnection().prepareStatement(SqlDel)) {
    ...
    public List<User> getAllUsers() {
        ...
        ResultSet rs = null;
        try (PreparedStatement prSt = util.getConnection().prepareStatement(SqlGetAll)) {
